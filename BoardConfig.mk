...
TARGET_FASTBOOTD_BYPASS_LOCK_STATE := true
...
TARGET_HEALTH_CHARGING_CONTROL_CHARGING_PATH := /sys/devices/platform/charger/charging_enabled
...
BOARD_MAIN_SIZE := 4827643904 # (BOARD_SUPER_PARTITION_SIZE - 4 * 1024 * 1024)
